...
- Project: `vocab-master-2.0 / miniprogram`
...
### 1.1 Syntax check
- PASS: `node --check miniprogram/src/api.js`
- PASS: `node --check miniprogram/src/socket.js`
- PASS: `node --check miniprogram/src/static/cloudfunctions/auth/index.js`
- PASS: `node --check miniprogram/src/static/cloudfunctions/words/index.js`
- PASS: `node --check miniprogram/src/static/cloudfunctions/progress/index.js`
- PASS: `node --check miniprogram/src/static/cloudfunctions/admin/index.js`
