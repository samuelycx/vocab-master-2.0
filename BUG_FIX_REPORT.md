...
**影响范围**：
- `client-uni/src/api.js` - login函数
- `client-uni/src/state.js` - 系统信息初始化
...
**影响范围**：
- `client-uni/src/components/Dashboard.vue` - 统计卡片和快捷功能图标
- `client-uni/src/components/GameArena.vue` - 反馈图标和音量按钮
