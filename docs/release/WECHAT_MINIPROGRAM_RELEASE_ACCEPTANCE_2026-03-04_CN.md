...
- 项目：`vocab-master-2.0 / miniprogram`
...
### 1.1 语法检查
- 通过：`node --check miniprogram/src/api.js`
- 通过：`node --check miniprogram/src/socket.js`
- 通过：`node --check miniprogram/src/static/cloudfunctions/auth/index.js`
- 通过：`node --check miniprogram/src/static/cloudfunctions/words/index.js`
- 通过：`node --check miniprogram/src/static/cloudfunctions/progress/index.js`
- 通过：`node --check miniprogram/src/static/cloudfunctions/admin/index.js`
